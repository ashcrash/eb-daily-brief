...
function peopleHtml(people) {
  ...
  return section('👥 Stakeholder & supplier status', `<div class="m-people">${people.map(p => {
    ...
    return `<div class="m-person${p.needsInfo ? ' needs-info' : ''}"><div class="m-person-h"><div class="m-person-av">${esc(p.emoji)}</div>
...
function risksHtml(risks) {
  ...
  return section('⚠️ Top risks right now', `<div class="m-risk">${risks.map((r, i) => {
